...
const CUSTOM_NATIVE_CAPABILITIES: PlayerCapabilities = {
  play: true,
  pause: true,
  seek: true,
  setVolume: true,
...
export abstract class BaseCustomNativePlayer extends BasePlayer {
  readonly capabilities = CUSTOM_NATIVE_CAPABILITIES;
